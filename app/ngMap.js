angular.module("ngMap", []), function () {
  "use strict";
  var e, t = function (t, n, o, i, r, a) {
    e = r;
    var s = this;
    s.mapOptions, s.mapEvents, s.ngMapDiv, s.addObject = function (e, t) {
      if (s.map) {
        s.map[e] = s.map[e] || {};
        var n = Object.keys(s.map[e]).length;
        s.map[e][t.id || n] = t, "infoWindows" != e && t.setMap && t.setMap && t.setMap(s.map), t.centered && t.position && s.map.setCenter(t.position), "markers" == e && s.objectChanged("markers"), "customMarkers" == e && s.objectChanged("customMarkers")
      }
    }, s.deleteObject = function (e, t) {
      if (t.map) {
        var n = t.map[e];
        for (var o in n)n[o] === t && delete n[o];
        t.map && t.setMap && t.setMap(null), "markers" == e && s.objectChanged("markers"), "customMarkers" == e && s.objectChanged("customMarkers")
      }
    }, s.observeAttrSetObj = function (t, n, o) {
      ...
      for (var t in s.map.markers)e.extend(s.map.markers[t].getPosition());
      for (var n in s.map.customMarkers)e.extend(s.map.customMarkers[n].getPosition());
      s.map.fitBounds(e)
    }, s.objectChanged = function (e) {
      "markers" != e && "customMarkers" != e || "auto" != s.map.zoomToIncludeMarkers || s.zoomToIncludeMarkers()
    }, s.initializeMap = function () {
      var e = s.mapOptions, n = s.mapEvents, r = s.ngMapDiv;
      s.map = new google.maps.Map(r, {}), e.zoom = e.zoom || 15;
      var c = e.center;
      if (!e.center || "string" == typeof c && c.match(/\{\{.*\}\}/))e.center = new google.maps.LatLng(0, 0); else if (!(c instanceof google.maps.LatLng)) {
        var u = e.center;
        delete e.center, a.getGeoLocation(u, e.geoLocationOptions).then(function (n) {
          s.map.setCenter(n);
          var o = e.geoCallback;
          o && i(o)(t)
        }, function () {
          e.geoFallbackCenter && s.map.setCenter(e.geoFallbackCenter)
        })
      }
      s.map.setOptions(e);
      for (var l in n)google.maps.event.addListener(s.map, l, n[l]);
      s.observeAttrSetObj(p, o, s.map), s.singleInfoWindow = e.singleInfoWindow, google.maps.event.addListenerOnce(s.map, "idle", function () {
        a.addMap(s), e.zoomToIncludeMarkers && s.zoomToIncludeMarkers(), t.map = s.map, t.$emit("mapInitialized", s.map), o.mapInitialized && i(o.mapInitialized)(t, {map: s.map})
      })
    }, t.google = google;
    var p = e.orgAttributes(n), c = e.filter(o), u = e.getOptions(c), l = e.getControlOptions(c), g = angular.extend(u, l), d = e.getEvents(t, c);
    s.mapOptions = g, s.mapEvents = d, s.ngMapDiv = a.getNgMapDiv(n[0]), n.append(s.ngMapDiv), u.lazyInit ? (s.map = {id: o.id}, a.addMap(s)) : s.initializeMap(), n.bind("$destroy", function () {
      a.deleteMap(s)
    })
  };
  t.$inject = ["$scope", "$element", "$attrs", "$parse", "Attr2MapOptions", "NgMap"], angular.module("ngMap").controller("__MapController", t)
}(), function () {
  "use strict";
  var e, t = function (t, o, i, r) {
    r = r[0] || r[1];
    var a = e.orgAttributes(o), s = e.filter(i), p = e.getOptions(s), c = e.getEvents(t, s), u = n(p, c);
  ...
  "use strict";
  var e, t, n, o = function (o, i, r, a) {
    a = a[0] || a[1];
    var s = e.filter(r), p = e.getOptions(s), c = e.getEvents(o, s), u = i[0].parentElement.removeChild(i[0]);
    t(u.innerHTML.trim())(o);
    for (var l in c)google.maps.event.addDomListener(u, l, c[l]);
    a.addObject("customControls", u), n.getMap().then(function (e) {
      var t = p.position;
      e.controls[google.maps.ControlPosition[t]].push(u)
    })
  }, i = function (i, r, a) {
  ...
  var e, t, n, o, i = function (e) {
    e = e || {}, this.el = document.createElement("div"), this.el.style.display = "inline-block", this.visible = !0;
    ...
    i.prototype = new google.maps.OverlayView, i.prototype.setContent = function (e, t) {
      ...
      if (e && (this.position = e), this.getProjection() && "function" == typeof this.position.lng) {
        var t = this.getProjection().fromLatLngToDivPixel(this.position), n = Math.round(t.x - this.el.offsetWidth / 2), o = Math.round(t.y - this.el.offsetHeight - 10);
        this.el.style.left = n + "px", this.el.style.top = o + "px"
      }
    ...
    return function (a, s, p, c) {
      c = c[0] || c[1];
      var u = e.orgAttributes(s), l = e.filter(p), g = e.getOptions(l, a), d = e.getEvents(a, l), f = s[0].parentElement.removeChild(s[0]), m = new i(g);
      t(function () {
        a.$watch("[" + r.join(",") + "]", function () {
          m.setContent(n, a)
        }), m.setContent(f.innerHTML, a);
        var e = f.firstElementChild.className;
        m.addClass("custom-markerPosition"), m.addClass(e), g.position instanceof google.maps.LatLng || o.getGeoLocation(g.position).then(function (e) {
          m.setPosition(e)
        })
      });
      for (var v in d)google.maps.event.addDomListener(m.el, v, d[v]);
  ...
  var e, t, n, o = function (e, t) {
    ...
    var u = function (n, r, a, s) {
      s = s[0] || s[1];
      var p = c.orgAttributes(r), u = c.filter(a), l = c.getOptions(u), g = c.getEvents(n, u), d = c.getAttrsToObserve(p), f = o(l, g);
  ...
  angular.module("ngMap").directive("drawingManager", ["Attr2MapOptions", function (e) {
    ...
    return {
      restrict: "E", require: ["?^map", "?^ngMap"], link: function (e, n, o, i) {
        i = i[0] || i[1];
        var r = t.filter(o), a = t.getOptions(r), s = t.getControlOptions(r), p = t.getEvents(e, r), c = new google.maps.drawing.DrawingManager({
  ...
  angular.module("ngMap").directive("dynamicMapsEngineLayer", ["Attr2MapOptions", function (e) {
    ...
    return {
      restrict: "E", require: ["?^map", "?^ngMap"], link: function (e, o, i, r) {
        r = r[0] || r[1];
        var a = t.filter(i), s = t.getOptions(a), p = t.getEvents(e, a, p), c = n(s, p);
  ...
  angular.module("ngMap").directive("heatmapLayer", ["Attr2MapOptions", "$window", function (e, t) {
    ...
    return {
      restrict: "E", require: ["?^map", "?^ngMap"], link: function (e, o, i, r) {
        r = r[0] || r[1];
        var a = n.filter(i), s = n.getOptions(a);
  ...
  var e = function (e, t, n, o, i) {
    var r = e, a = function (e, o, i) {
      var r;
      !e.position || e.position instanceof google.maps.LatLng || delete e.position, r = new google.maps.InfoWindow(e), Object.keys(o).length > 0;
      ...
      var p, c = r.orgAttributes(t), u = r.filter(n), l = r.getOptions(u), g = r.getEvents(e, u);
      ...
      p && i.getGeoLocation(p).then(function (t) {
        ...
        var i = n.geoCallback;
        i && o(i)(e)
      }), s.addObject("infoWindows", d), s.observeAttrSetObj(c, n, d), s.map.showInfoWindow = s.map.showInfoWindow || function (t, n, o) {
          var i = "string" == typeof t ? t : n, r = "string" == typeof t ? n : o;
          "string" == typeof r && (r = s.map.markers[r]);
        ...
        }, s.map.hideInfoWindow = s.map.hideInfoWindow || function (e, t) {
  ...
  angular.module("ngMap").directive("kmlLayer", ["Attr2MapOptions", function (e) {
    ...
    return {
      restrict: "E", require: ["?^map", "?^ngMap"], link: function (e, o, i, r) {
        r = r[0] || r[1];
        var a = t.orgAttributes(o), s = t.filter(i), p = t.getOptions(s), c = t.getEvents(e, s), u = n(p, c);
  ...
  angular.module("ngMap").directive("mapData", ["Attr2MapOptions", "NgMap", function (e, t) {
    ...
    return {
      restrict: "E", require: ["?^map", "?^ngMap"], link: function (e, o, i) {
        var r = n.filter(i), a = n.getOptions(r), s = n.getEvents(e, r, s);
  ...
  var e, t, n, o, i = function (n, i, r) {
    ...
    return !t.mapLazyLoad && void 0, o = e.html(), n = t.mapLazyLoad, document.querySelector('script[src="' + n + (n.indexOf("?") > -1 ? "&" : "?") + 'callback=lazyLoadCallback"]') ? !1 : (e.html(""), {pre: i})
  }, a = function (n, o) {
  ...
  "use strict";
  var e = function () {
    return {restrict: "AE", controller: "__MapController", conrollerAs: "ngmap"}
  };
  ...
  var e, t, n, o = function (e, t) {
    var o;
    if (n.defaultOptions.markerPosition)for (var i in n.defaultOptions.markerPosition)"undefined" == typeof e[i] && (e[i] = n.defaultOptions.markerPosition[i]);
    ...
    s = s[0] || s[1];
    var p, c = e.orgAttributes(r), u = e.filter(a), l = e.getOptions(u, i), g = e.getEvents(i, u);
  ...
  var e = function (e, t) {
    var n = e, o = function (e, o, i, r) {
      ...
      var a = n.filter(i), s = n.getOptions(a), p = n.getEvents(e, a), c = new google.maps.places.Autocomplete(o[0], s);
      for (var u in p)google.maps.event.addListener(c, u, p[u]);
      var l = function () {
        t(function () {
  ...
  var e = function (e, t) {
    ...
    var i = t, r = function (t, r, a, s) {
      s = s[0] || s[1];
      var p, c, u = i.orgAttributes(r), l = i.filter(a), g = i.getOptions(l), d = i.getEvents(t, l);
      ...
      s.addObject("shapes", f), p && "circle" == c && o.getGeoLocation(p).then(function (e) {
        ...
        var o = a.geoCallback;
        o && n(o)(t)
      }), s.observeAttrSetObj(u, a, f), r.bind("$destroy", function () {
  ...
  var e = function (e, t) {
    var n = e, o = function (e, t, n) {
      ...
      var a = n.filter(r), s = n.getOptions(a), p = n.getControlOptions(a), c = angular.extend(s, p), u = n.getEvents(e, a);
      t.getMap().then(function (e) {
        var t = o(e, c, u);
  ...
  var isoDateRE = /^(\d{4}\-\d\d\-\d\d([tT][\d:\.]*)?)([zZ]|([+\-])(\d\d):?(\d\d))?$/, Attr2MapOptions = function ($parse, $timeout, $log, NavigatorGeolocation, GeoCoder, camelCaseFilter, jsonizeFilter) {
    var orgAttributes = function (e) {
      ...
      if ("bounds" == options.key && output instanceof Array && (output = new google.maps.LatLngBounds(output[0], output[1])), "icons" == options.key && output instanceof Array)for (var i = 0; i < output.length; i++) {
        var el = output[i];
      ...
      for (var o in e)if (e[o] || 0 === e[o]) {
        ...
        n[o] = "string" != typeof e[o] ? e[o] : t && t.doNotConverStringToNumber && e[o].match(/^[0-9]+$/) ? e[o] : toOptionValue(e[o], {key: o})
      }
      return n
  ...
  "use strict";
  var e, t, n, o, i, r, a, s = {}, p = function (e) {
    var t = s[e || 0];
    t.initializeMap()
  }, c = function (t) {
    function o(t) {
      s[r] ? i.resolve(s[r].map) : t > a ? i.reject("could not find map") : e.setTimeout(function () {
        o(t + 100)
      }, 100)
    }

    t = t || {};
    var i = n.defer(), r = t.id || 0, a = t.timeout || 2e3;
    ...
    var n = t.createElement("div"), o = e.getAttribute("default-style");
    return n.style.width = "100%", n.style.height = "100%", "true" == o ? (e.style.display = "block", e.style.height = "300px") : ("block" != g(e, "display") && (e.style.display = "block"), g(e, "height").match(/^(0|auto)/) && (e.style.height = "300px")), n.addEventListener("dragstart", function (e) {
    ...
    return function (n) {
      if (n) {
        ...
        t[o] && (e.match(/center|position/) && "string" == typeof r ? f(r).then(function (e) {
          t[o](e)
        }) : t[o](r))
      }
    }
  ...
  angular.module("ngMap").provider("NgMap", function () {
    ...
    var v = function (v, y, h, M, O, b, w) {
      return e = v, t = y[0], n = h, o = M, i = O, r = b, a = w, {
        defaultOptions: s,
        addMap: u,
        deleteMap: l,
        getMap: c,
    ...
    v.$inject = ["$window", "$document", "$q", "NavigatorGeolocation", "Attr2MapOptions", "GeoCoder", "camelCaseFilter"], this.$get = v
  })
}(), function () {
  "use strict";
